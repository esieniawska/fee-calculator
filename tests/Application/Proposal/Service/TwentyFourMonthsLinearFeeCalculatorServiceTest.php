...
class TwentyFourMonthsLinearFeeCalculatorServiceTest extends TestCase
{
    ...
    public function testSuccessfulCalculate(): void
    {
        ...
        $repositoryMock
            ->getFeeStructureForDuration(LoanDuration::TWENTY_FOUR_MONTHS())
            ->willReturn(
        ...
        $service = new TwentyFourMonthsLinearFeeCalculatorService(
